                ...
                <div className={s.lightpink_border}>
                  ...
                  <div className={s.first_comment}>
                    ...
                    <p className={s.comment_main}>
                      ...
                      Ce week-end, j'ai vécu une soirée de ouf avec les potes à
                      la maison. On a passé des heures à discuter sur MSN, à
                      choisir nos meilleurs sons pour notre profil Myspace, et à
                      partager nos derniers secrets de cœur. Trop de fun ! 💖{" "}
                      <br /> <br />
                  ...
                  <div className={s.first_comment}>
                    ...
                    <p className={s.comment_main}>
                      ...
                      fleurs parfaite, façon 90s revival. Vous savez, celles
                      avec des motifs psychédéliques qui nous font sentir comme
                      des Spice Girls en puissance! Spice up your life, non?
                      🌸✌️
                      <br /> <br />
                      J'ai aussi déniché des mini sacs trop cute. Vous avez des
                      adresses cool pour shopper des fringues rétro? Partagez
                      vos bons plans! 👗🛍️ <br /> <br />
                  ...
                  <div className={s.first_comment}>
                    ...
                    <p className={s.comment_main}>
                      ...
                      vous avez des idées de motifs ou de couleurs à ajouter, je
                      suis toute ouïe! 🌈💕 <br /> <br />
